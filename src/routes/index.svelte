...
<div class="relative bg-gray-50">
  ...
  <main class="lg:relative">
    <div
      class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48
      lg:text-left">
      <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
        ...
        <p
          ...
          md:max-w-3xl">
          This is a bunch of really cool generic text that every reward site has
    ...
    <div
      class="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto text-center">
      <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">
        Loved by all your fellow bobloxians!
      </h2>
      <p class="mt-3 text-xl text-gray-500 sm:mt-4">
        We are such a great service! All the bobloxians love us! Even your mom!
      </p>
    </div>
  </div>
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
          <dl class="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
            <div
              class="flex flex-col border-b border-gray-100 p-6 text-center
            ...
            <div
              class="flex flex-col border-t border-b border-gray-100 p-6
...
<footer class="bg-gray-50">
  <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
    ...
    <p class="mt-8 text-center text-base text-gray-400">
      &copy; 2021 Bobux, Inc. All rights reserved.
    </p>
  </div>
</footer>
